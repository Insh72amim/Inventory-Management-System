...
if(isset($_POST['submit'])){
	...
	$sql_stmt="SELECT * FROM pharmacist WHERE username='$user'";
	...
	if($rows){
		...
		if ($conn->query($sql) === TRUE) {
			$var1 = "http://".$_SERVER['HTTP_HOST'].dirname($_SERVER['PHP_SELF'])."/admin_pharmacist.php";
	...
	<div id="content">
       ...
       // get results from database
        ...
        while($row = mysqli_fetch_array( $result )) {
        	...
        	?>
        	<td><a href="update_pharmacist.php?username=<?php echo $row['username']?>"><img src="images/update.png" width="35" height="35" border="0" /></a></td>
        	<td><a href="delete_pharmacist.php?pharmacist_id=<?php echo $row['pharmacist_id']?>"><img src="images/delete.png" width="35" height="35" border="0" /></a></td>
        	<?php
        } 
        // close table>
        echo "</table>";
