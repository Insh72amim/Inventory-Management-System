...
if(isset($_POST['submit'])){
	...
	$sql_stmt="SELECT * FROM manager WHERE username='$user'";
	...
	if($rows){
		...
		$var1 = "http://".$_SERVER['HTTP_HOST'].dirname($_SERVER['PHP_SELF'])."/admin_manager.php";
		...
		$sql = "INSERT INTO manager(first_name,last_name,staff_id,postal_address,phone,email,username,password,date) VALUES('$fname','$lname','$sid','$postal','$phone','$email','$user','$pas',NOW())";
	...
	<div id="content">
		...
		*/
        ...
        while($row = mysqli_fetch_array( $result )) {
        	...
        	?>
        	<td><a href="update_manager.php?username=<?php echo $row['username']?>"><img src="images/update.png" width="35" height="35" border="0" /></a></td>
        	<td><a href="delete_manager.php?manager_id=<?php echo $row['manager_id']?>"><img src="images/delete.png" width="35" height="35" border="0" /></a></td>
        	<?php
        } 
        // close table>
        echo "</table>";
